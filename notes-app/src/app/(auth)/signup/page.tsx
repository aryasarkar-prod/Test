      ...
      >
        ...
        <div className="grid grid-cols-2 gap-2 mb-6">
          {perks.map((perk) => (
            <div key={perk} className="flex items-center gap-2 text-xs text-[var(--text-secondary)]">
              <div className="w-4 h-4 rounded-full bg-green-100 dark:bg-green-500/10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-3 bg-[var(--bg-primary)] text-[var(--text-muted)]">or with email</span>
          </div>
        </div>
